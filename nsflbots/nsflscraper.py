...
while True:
    ...
    standingsURL = "https://index.sim-football.com/NSFLS23//"
    ...
    url = "https://index.sim-football.com/NSFLS23/LeaguePassingStats.html"
    page = requests.get(url, headers=headers)
    soup = BeautifulSoup(page.content, 'html.parser')
    tb = soup.find('table', class_='tablesorter')
    table_rows = tb.find_all("tr")

    wrurl = "https://index.sim-football.com/NSFLS23/LeagueReceivingStats.html"
    ...
    rburl = "https://index.sim-football.com/NSFLS23/LeagueRushingStats.html"
    ...
    dfurl = "https://index.sim-football.com/NSFLS23/LeagueDefensiveStats.html"
    ...
    kurl = "https://index.sim-football.com/NSFLS23/LeagueKickingStats.html"
    ...
    purl = "https://index.sim-football.com/NSFLS23/LeaguePuntingStats.html"
    ...
    olurl = "https://index.sim-football.com/NSFLS23/LeagueOffensiveLineStats.html"
    ...
    rurl = "https://index.sim-football.com/NSFLS23/LeagueSpecialTeamsStats.html"
    ...
    """
    with open('nsflstandings.csv', 'w', newline='') as file:
        swr = csv.writer(file)
